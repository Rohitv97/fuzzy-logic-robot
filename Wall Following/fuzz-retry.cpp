...
int main(int argc, char **argv)
{
	...
	Member m1;
	m1.memberName = "L";
	m1.linePoint = { { 0,1 },{ 250,1 },{ 450,0 } };
	Member m2;
	m2.memberName = "M";
	m2.linePoint = { { 250,0 },{ 450,1 },{ 650,0 } };
	Member m3;
	m3.memberName = "H";
	m3.linePoint = { { 450,0 },{ 650,1 },{ 2000,1 } };
	...
	RuleTable rule;
	rule = { { { "L","L","L","M" },{ "L","M","M","H" },{ "L","H","L","H" } ,{ "M","L","M","L" } ,{ "M","M","M","M" } ,{ "M","H","L","H" } ,{ "H","L","M","L" } ,{ "H","M","H","M" } ,{ "H","H","H","L" } } };
